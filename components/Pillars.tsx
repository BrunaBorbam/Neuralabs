...
export const Pillars = () => {
  return (
    <section id="pilares" className="py-24 px-6 bg-[#0A0E27]">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-10 items-stretch relative">
          {pillars.map((pillar) => (
            <ScrollReveal key={pillar.title}>
              <Card variant="accent" className="h-full flex flex-col">
                ...
                <p className="text-slate-400 leading-relaxed mb-6 flex-1">{pillar.description}</p>
          ...
          <div className="hidden md:flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10 w-12 h-12 rounded-full bg-[#0A0E27] border border-orange-500/40 items-center justify-center shadow-lg shadow-orange-500/20">
